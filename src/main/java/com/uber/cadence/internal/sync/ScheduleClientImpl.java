...
final class ScheduleClientImpl implements ScheduleClient {
  ...
  @Override
  public CompletableFuture<Void> updateSchedule(String scheduleId, UpdateScheduleRequest request) {
    request.setDomain(domain);
    request.setScheduleId(scheduleId);
  ...
  @Override
  public CompletableFuture<Void> backfillSchedule(
    ...
    return CompletableFuture.runAsync(
        () -> {
          for (ScheduleBackfill bf : backfills) {
            ...
            try {
              service.BackfillSchedule(request);
            } catch (Exception e) {
              throw new RuntimeException(e);
            }
          }
