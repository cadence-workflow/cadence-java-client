...
public class WorkflowServiceGrpc implements IWorkflowService {
  ...
  @Override
  public void GetClusterInfo(AsyncMethodCallback<ClusterInfo> resultHandler) throws CadenceError {
    Futures.addCallback(
        grpcServiceStubs
            .workflowFutureStub()
            .getClusterInfo(com.uber.cadence.api.v1.GetClusterInfoRequest.getDefaultInstance()),
  ...
  private CadenceError toServiceClientException(Throwable t) {
    if (t instanceof CadenceError) {
      return (CadenceError) t;
